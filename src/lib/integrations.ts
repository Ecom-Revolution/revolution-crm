...
export const AI_PROVIDER_CATALOG: IntegrationCatalogItem[] = [
  {
    ...
    baseUrlHint: "https://ai.gateway.lovable.dev/v1/chat/completions",
    description: "Routeur IA simple et gratuit pour le CRM. C'est le fallback principal.",
    value: "Très bon point de départ, zéro friction.",
    cliSupport: "no",
  },
  {
    provider: "gemini",
...
export const INTEGRATION_CHOICES = [
  {
    ...
    items: ["Lovable ou Gemini", "Groq en fallback", "PageSpeed, DuckDuckGo, CSV"],
  },
  {
    title: "Stack équilibrée",
    label: "Gemini + Claude + HubSpot/Sheets",
    description: "Bon compromis entre qualité IA, delivery et opérations commerciales.",
    items: ["Gemini pour le volume", "Claude pour les prompts premium", "Sheets/Notion/Slack"],
  },
  {
    title: "Stack avancée",
    label: "OpenAI + Claude + APIs métiers",
    description: "Pour une agence plus mature, avec plus de stabilité et de contrôle.",
