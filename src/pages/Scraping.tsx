...
import { MapPin, Building2, Mail, Instagram, Music2, Linkedin, Sparkles, History, Upload } from "lucide-react";
...
const SOURCES = [
  ...
  { id: "csv", label: "Import CSV", icon: Upload, color: "text-green-400" },
];
